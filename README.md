...
## Code use
After cloning the GitHub repository and installing the dependencies -- which should take only a few minutes -- the code can be tested using the notebook `Plots_spectra.ipynb`.
